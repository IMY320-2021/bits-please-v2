...
True Type Font: Serif Pixel-7 version 1.0


EULA
-==-
The font Serif Pixel-7 is freeware for home using only.


DESCRIPTION
-=========-
Classic serif pixel font. Size is 5*8 pixels. Latin and Cyrillic code pages are supported.

Files in serif_pixel-7.zip:
       	readme.txt     			this file;
        serif_pixel-7.ttf    		regular font;
	serif_pixel-7_screen.png	preview image.
