    ...
    <>
      <div>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <h1 style={{ paddingTop: 10, paddingBottom: 10 }} className={colour}>
            {title}
          </h1>
          <button
            className="nes-btn is-primary"
